...
public class Controlador {
	...
	public int controlaExecucao(Cpu cpu, SistemaOperacional so, Timer timer) {
		...
		while(true) {
			...
			if(cpu.getCodigotInterrupcao() == InterrupcaoCPU.INSTRUCAO_ILEGAL || cpu.getCodigotInterrupcao() == InterrupcaoCPU.VIOLACAO_DE_MEMORIA || cpu.getCodigotInterrupcao() == InterrupcaoCPU.PAGE_FAULT) {
